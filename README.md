...
## Project Structure
    ...
    ├── testdeployment_dev_24028  # Django project configurations
...
1. Clone this repo and `cd testdeployment_dev_24028`
...
2. Clone this repo and `cd testdeployment_dev_24028`
